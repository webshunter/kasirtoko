      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ url("accounting/setting/asset/update") }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select required class="form-control" name="type_kelompok" id="type_kelompok">
                            <option value="{{ $data->type_kelompok }}">{{ $data->type_kelompok }}</option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required autocomplete="off" name="kelompok_harta" value="{{ $data->kelompok_harta }}" placeholder="isikan data">
                    </div>
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="input-group mb-3">
                          <input type="number" class="form-control" name="masa_manfaat" value="{{ $data->masa_manfaat }}" placeholder="masa manfaat">
                      ...
                      <div class="col-sm-4">
                        <div class="input-group mb-3">
                          <input type="text" class="form-control" name="garis_lurus" value="{{ str_replace("%", "",$data->garis_lurus) }}"  placeholder="metode garis lurus">
                          <div class="input-group-append">
                      ...
                      <div class="col-sm-4">
                        <div class="input-group mb-3">
                          <input type="text" class="form-control" name="saldo_menurun" value="{{ str_replace("%","",$data->saldo_menurun) }}" placeholder="metode saldo menurun">
                          <div class="input-group-append">
                            <span class="input-group-text">%</span>
                          </div>
                        </div>
